...
const cargarTabla=()=>{
    ...
    datos.map((item)=>{//Se recorre con map por qué es un arreglo y se nombra a cada elemento item
...
window.borrarGift=(id)=>{
    ...
    let validar = confirm(`¿Está seguro/a que quiere eliminar el estudiante ${datos[index].gift}?`);
